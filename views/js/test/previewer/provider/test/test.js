...
define([
    ...
    'taoQtiTestPreviewer/previewer/provider/test/test',
    ...
    QUnit.test('module', assert => {
        ...
        assert.equal(typeof testPreviewerProvider, 'object', 'The module exposes an object');
        assert.equal(testPreviewerProvider.name, 'qtiTestPreviewer', 'The provider has the expected name');
    ...
    QUnit.cases.init([
        ...
        assert.equal(typeof testPreviewerProvider[data.title], 'function', `The provider expose a ${data.title} function`);
    });
