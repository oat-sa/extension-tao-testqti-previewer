...
class QtiTestPreviewerServiceProvider implements ContainerServiceProviderInterface
{
    public function __invoke(ContainerConfigurator $configurator): void
    {
        ...
        $services
            ->set(TestPreviewerAssessmentTestGenerator::class, TestPreviewerAssessmentTestGenerator::class)
            ->call('setServiceManager', [service(ServiceManager::class)]);
        $services
            ->set(TestPreviewMapper::class, TestPreviewMapper::class)
            ->call('setServiceManager', [service(ServiceManager::class)]);
        $services
        ...
        $services
            ...
            ->args(
                [
                    ...
                    service(TestPreviewerAssessmentTestGenerator::class),
                    service(TestPreviewMapper::class),
